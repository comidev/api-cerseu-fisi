package comidev.apicerseufisi.email;
...
import comidev.apicerseufisi.components.notificacion.NotificacionService;
...
public class EmailSenderService {
    ...
    private static final String FROM = "comidev.contacto@gmail.com";

    @Async
    public void send(NotificacionCreate notificacionCreate) {
        String text = buildEmail(notificacionCreate.getContenido());
        String to = notificacionCreate.getToEmail();
        String subject = notificacionCreate.getTema();
        ...
        try {
            ...
            notificacionService.registrarNotificacion(notificacionCreate);
    ...
    private String buildEmail(ContenidoCreate contenido) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                +
                "    <tbody><tr>\n" +
                "      <td width=\"100%\" height=\"53\" bgcolor=\"#57f\">\n" +
                "        \n" +
                "        <table role=\"presentation\" width=\"100%\" style=\"border-collapse:collapse;max-width:580px\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"center\">\n"
                +
                "          <tbody><tr>\n" +
                "            <td width=\"70\" bgcolor=\"#57f\" valign=\"middle\">\n" +
                ...
                +
                "                  <tbody><tr>\n" +
                "                    <td bgcolor=\"#EEE8AA\" width=\"100%\" height=\"10\"></td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "        \n" +
                "      </td>\n" +
                ...
                + contenido.getEnlace() + "\">" + contenido.getEnlaceName() + "</a></p></blockquote>\n<p>"
                + contenido.getPie() + "</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
